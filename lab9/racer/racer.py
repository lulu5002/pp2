...
COINS_DICTIONARY = {'1': r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\coin_1.png', '2': r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\coin_2.png'}
...
background = pygame.image.load(r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\street.png')  # background image
pygame.mixer.init()  # initializing music component
pygame.mixer.music.set_volume(0.45)  # volume of music
pygame.mixer.music.load(r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\lab9_racer_background.wav')  # music that will be played while playing the game
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\enemy.png')  # image of enemy car
        self.rect = self.image.get_rect()  # rectangle of image
        self.set_random_position()
...
class Player(pygame.sprite.Sprite):  # Player is moving by x-axis. It can collide with coin or enemy car
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r'C:\Users\aluao\OneDrive\Рабочий стол\pp2\lab9\racer\player.png')  # image of player
        self.rect = self.image.get_rect()  # rectangle of image
